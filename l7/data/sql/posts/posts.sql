INSERT INTO post (title, subtitle, content, author, author_url, publish_date, image_url, button, img_name, featured) VALUES ('Try it Always', 'The world is a book, and those who do not travel read only one page.', 'Dark spruce forest frowned on either side the frozen waterway. The trees had been stripped by a recent
    ...
    life. It was the Wild, the savage, frozen-hearted Northland Wild.<br />
    ...
    on the snow. The front end of the sled was turned up, like a scroll, in order to force down and under
    the bore of soft snow that surged like a wave before it. On the sled, securely lashed, was a long and
    narrow oblong box. There were other things on the sled—blankets, an axe, and a coffee-pot and
    frying-pan; but prominent, occupying most of the space, was the long and narrow oblong box.<br />
    ...
    the end come to the cessation of movement.<br />
    ...
    crystals from their frozen breath that their faces were not discernible. This gave them the seeming of
    ghostly masques, undertakers in a spectral world at the funeral of some ghost. But under it all they
    were men, penetrating the land of desolation and mockery and silence, puny adventurers bent on colossal
    adventure, pitting themselves against the might of a world as remote and alien and pulseless as the
    abysses of space.', 
	 'Mat Vogels', 'http://localhost:8001/static/images/mat_vogels.jpg', '0, 0, 0, 9, 25, 2015','http://localhost:8001/static/images/waterfall.png', '','waterfall', 0);